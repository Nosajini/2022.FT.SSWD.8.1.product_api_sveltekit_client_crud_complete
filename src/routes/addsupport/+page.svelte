<script>
	...
	import {getAllsupportAreas, supportAreas} from '../../stores/supportStore.js';
...
<div class="container">
	...
	{#if form?.success}
		...
		<div class="row">
			...
			<div class="row mb-3">
				<h6>Support Area: {form?.support.supportArea_id || ''}</h6>
			</div>
			<div class="row mb-3">
	...
	{:else}
		...
		<div class="row">
			...
			<form
			 ...
			 >
				<div class="row mb-3">
					<label for="supportArea_id" class="form-label">Support Area:</label>
					<div class="col-sm-8">
						<select id="category_id" class="form-select" name="supportArea_id">
